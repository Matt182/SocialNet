...
try {
	...
	$conn->exec("CREATE TABLE IF NOT EXISTS `hive2`.`members` ( `id` INT NOT NULL AUTO_INCREMENT ,
	...
	$conn->exec("CREATE TABLE IF NOT EXISTS `hive2`.`blog_records` ( `id` INT NOT NULL AUTO_INCREMENT ,
	...
	$conn->exec("CREATE TABLE IF NOT EXISTS `hive2`.`comments` ( `id` INT NOT NULL AUTO_INCREMENT ,
