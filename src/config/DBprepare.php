...
try {
    ...
    $conn->exec(
        "CREATE TABLE IF NOT EXISTS $dbname.members ( id INT NOT NULL SERIAL ,
    ...
    $conn->exec(
        "CREATE TABLE IF NOT EXISTS $dbname.blog_records ( id INT NOT NULL SERIAL ,
    ...
    $conn->exec(
        "CREATE TABLE IF NOT EXISTS $dbname.comments ( id INT NOT NULL SERIAL ,
